...
public enum Comandos {
    ...
    SALDOS_GRUPO, INFORMACOES, EDITAR_DADOS, LOGOUT, VISUALIZAR_CONVITES, RESPONDER_CONVITE, NOTIFICACAO, VISUALIZAR_TOTAL_GASTOS_GRUPO, VISUALIZAR_HISTORICO_DESPESAS, EXPORTAR_DESPESAS_CSV;
